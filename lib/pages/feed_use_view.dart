...
import 'package:myfarm/pages/feed_history_page.dart';
import '../controller/feed_use_controller.dart';

class FeedUseView extends StatelessWidget {
  final FeedUseController controller = Get.put(FeedUseController());

  FeedUseView({super.key});
  ...
  //         color: isActive ? const Color(0xFF6B4AC3) : Colors.white,
  ...
  //         text,
  //         style: TextStyle(
  //           color: isActive ? Colors.white : const Color(0xFF6B4AC3),
  //           fontSize: 12,
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        const Spacer(),
                        SizedBox(), // Placeholder for removed containers
                      ],
                    ),
                                        ...
                                        RichText(
                                          ...
                                          text: TextSpan(
                                            ...
                                            children: [
                                              const TextSpan(
                                                text:
                                                    'Pastikan data yang diinput sudah benar !!!\nData akan masuk ke draft history terlebih dahulu.',
                                              ),
                                            ],
                                          ),
                                        ),
